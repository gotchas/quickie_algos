...
cmake --no-warn-unused-cli -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_BUILD_TYPE:STRING=Debug -H$THIS_DIR -B$THIS_DIR/build -G Ninja -DHUNTER_STATUS_DEBUG=ON -DCMAKE_CXX_COMPILER:FILEPATH=/bin/g++-10 # -DCMAKE_PROJECT_INCLUDE_BEFORE:STRING=$THIS_DIR/SetupHunter.cmake
