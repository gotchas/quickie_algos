...
BUILD_TYPE=Release
cmake --no-warn-unused-cli -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_BUILD_TYPE:STRING=$BUILD_TYPE -H$THIS_DIR -B$THIS_DIR/build -G Ninja -DHUNTER_STATUS_DEBUG=ON -DCMAKE_CXX_COMPILER:FILEPATH=g++-10 
